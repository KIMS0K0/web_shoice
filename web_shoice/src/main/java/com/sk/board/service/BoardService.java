...
import com.sk.board.mapper.BoardMapper;
import com.sk.board.mapper.FileMapper;
...
public class BoardService {
	...
	//글목록 조회
	public List<BoardDto> getAllMyList(MemberDto mdto){
		return boardMapper.getMyList(mdto.getId());
	}
